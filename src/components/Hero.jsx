  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute -inset-[40%] bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.15),transparent_60%)]" />
        <div className="absolute -inset-[80%] rotate-45 bg-[conic-gradient(from_0deg,rgba(99,102,241,0.12),transparent_40%)]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pt-28 pb-20 md:pt-36 md:pb-28">
        ...
        >
          <a href="#live" className="px-5 py-3 rounded-lg bg-white text-slate-900 font-medium hover:opacity-90 transition">See live shows</a>
